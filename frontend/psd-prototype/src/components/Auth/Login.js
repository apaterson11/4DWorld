...
const styles = (theme) => ({
  ...
  image: {
    backgroundImage:
      "url(https://images.unsplash.com/photo-1553864250-05b20249ee0c?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1000&q=80)",
  ...
  handleSubmit = (e) => {
    ...
    axiosInstance
      ...
      .then((response) => {
        ...
        axiosInstance
          .post("/ajax/check_username/", { username: this.state.username })
          .then((res) => {
            if (err.response.status == 401) {
              if (res.data.exists) {
                ...
                this.setState({
                  ...
                  usernameHelpText:
                    "No account is associated with this username",
                });
              }
            }
          });
