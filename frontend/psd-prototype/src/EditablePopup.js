...
var _rte = _interopRequireDefault(require("react-rte"));
var _createEditor = _interopRequireDefault(require("slate"));
var _Slate = _interopRequireDefault(require("slate-react"));
var _Editable = _interopRequireDefault(require("slate-react"));
var _withReact = _interopRequireDefault(require("slate-react"));
...
function (_React$Component) {
  ...
  function EditablePopup(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      ...
      inputValue: _rte.createValueFromString(_this.parsedChildren, 'html'),
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (e) {
      ...
      _this.setState = ({inputValue: e.toString('html')}) // problem line
  ...
  _createClass(EditablePopup, [{
    ...
    value: function render() {
      ...
      /*#__PURE__*/
      _react["default"].createElement(_rte["default"], {
        //className: "leaflet-popup-input",
        
        value: this.state.inputValue,
        //ref: "editableDiv",
        onChange: this.onChange(this.state.inputValue),
        autoFocus: true,
